	          ...
	          <fieldset class="login-box">
	              ...
	              <form id="loginForm" name="loginForm">
		              ...
		              <ul class="login-input">
		                  <li><span class="tit">아이디</span><input type="text" class="int required" id ="userId" name="userId" value="${param.userId}"  title="아이디"/></li>
		                  <li><span class="tit">비밀번호</span><input type="password" class="int password required" id ="password" name="password" title="패스워드"/></li>
		              </ul>
	             </form>
	          </fieldset>
	          <a href="#" id ="loginBtn" class="btn-login">로그인</a>
	        </div>
